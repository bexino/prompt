(() => {
  const resources = [
    ...
    '<link rel="stylesheet" href="./css/app/shell.css?v=2">',
    '<script src="./js/config/skin-config.js?v=12"><\/script>',
    '<script src="./js/config/font-config.js?v=2"><\/script>',
    '<script defer src="./js/config/app-config.js"><\/script>',
    '<script defer src="./js/config/asset-manifest.js?v=5"><\/script>',
    ...
    '<script defer src="./js/app/explorer-renderer.js?v=3"><\/script>',
    '<script defer src="./js/app/event-controller.js?v=3"><\/script>',
    '<script defer src="./js/app/bootstrap.js?v=4"><\/script>'
  ];
