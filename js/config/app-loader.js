(() => {
  const resources = [
    ...
    '<link rel="stylesheet" href="./css/app/shell.css?v=5">',
    '<script src="./js/config/skin-config.js?v=18"><\/script>',
    ...
    '<script defer src="./js/services/lazy-assets.js?v=5"><\/script>',
    ...
    '<script defer src="./js/components/loading-screen.js?v=2"><\/script>',
    '<script defer src="./js/services/file-import.js"><\/script>',
    '<script defer src="./js/services/clipboard.js"><\/script>',
    '<script defer src="./js/services/view-assets.js?v=2"><\/script>',
    '<script defer src="./js/app/explorer-renderer.js?v=5"><\/script>',
    '<script defer src="./js/app/view-coordinator.js?v=2"><\/script>',
    '<script defer src="./js/app/event-controller.js?v=5"><\/script>',
    '<script defer src="./js/app/bootstrap.js?v=6"><\/script>'
  ];

  // 只在首屏解析阶段注入资源，确保网址确定主题后仅请求对应资源。
